...
object Config {
    ...
    const val MAX_API_LAST_ACTIVE = 5000L//Hours.TWO.toStandardDuration().millis //2 hours in millis
    const val MAX_API_PRICES_LAST_RETRIEVED = 5000L//Hours.ONE.toStandardDuration().millis //2 hours in millis
